...
/**
 * The Index chart shows exactly what an admin has recorded in Price History —
 * nothing extrapolated or invented. Points are simply the real entries in
 * chronological order, starting from whichever date the first price was
 * actually entered.
 */
function buildExtendedHistory(pricesDesc) {
  return pricesDesc
    .slice()
    .reverse()
    .map((p) => ({
