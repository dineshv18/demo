...
export default function Register() {
  ...
  const inputClass = (hasError: boolean) =>
    `w-full rounded-xl border px-4 py-3 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 transition-all bg-[#F7F8F4] dark:bg-gray-800/50 ${
      hasError
  ...
  if (view === "success") {
    return (
      <div className="relative flex min-h-screen w-full bg-[#F7F8F4] dark:bg-gray-950 items-center justify-center px-6">
        <div className="w-full max-w-md space-y-8 text-center bg-white dark:bg-gray-900 rounded-2xl border border-[#DDE4DE] dark:border-gray-800 shadow-[0_8px_30px_rgba(16,33,29,0.05)] p-8">
          <div className="mx-auto grid h-20 w-20 place-items-center rounded-full bg-[#EAF7E8] ring-1 ring-[#00A94F]/20">
            <IconCircleCheck className="h-10 w-10 text-[#00A94F]" />
          </div>
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-[#10211D] dark:text-white">
              Account Created!
            </h2>
            <p className="mt-3 text-[#68736E] dark:text-gray-400 text-sm leading-relaxed">
              Your admin account has been verified. You can now access the dashboard.
            </p>
          </div>
          <button
            onClick={() => navigate("/dashboard")}
            className="w-full rounded-xl bg-[#10211D] py-3 text-sm font-semibold text-white hover:bg-[#1a332c] transition-all"
          >
            Go to Dashboard
          </button>
          <button
            onClick={() => navigate("/login")}
            className="w-full rounded-xl border border-[#DDE4DE] dark:border-gray-700 py-3 text-sm font-medium hover:bg-[#F3F8EF] dark:hover:bg-gray-800 transition-colors text-[#10211D] dark:text-gray-300"
          >
            Back to Sign In
          </button>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-12 lg:px-16">
          <div className="w-full max-w-md space-y-6 bg-white dark:bg-gray-900 rounded-2xl border border-[#DDE4DE] dark:border-gray-800 shadow-[0_8px_30px_rgba(16,33,29,0.05)] p-8">
            <button
              ...
              className="flex items-center gap-2 text-sm text-[#68736E] hover:text-[#10211D] dark:hover:text-gray-300 transition-colors"
            >
            ...
            <div className="text-center">
              <div className="mx-auto grid h-16 w-16 place-items-center rounded-full bg-[#EAF7E8] ring-1 ring-[#00A94F]/20 mb-4">
                <IconShield className="h-8 w-8 text-[#00A94F]" />
              </div>
              <h2 className="text-3xl font-bold tracking-tight text-[#10211D] dark:text-white">
                Enter OTP
              </h2>
              <p className="mt-2 text-[#68736E] dark:text-gray-400 text-sm">
                Code sent to <span className="font-medium text-[#10211D] dark:text-gray-300">{email}</span>
              </p>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#10211D] py-3 text-sm font-semibold text-white hover:bg-[#1a332c] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {otpLoading ? (
            ...
            <p className="text-center text-sm text-[#68736E] dark:text-gray-400">
        ...
        <div className="w-full max-w-md space-y-6 bg-white dark:bg-gray-900 rounded-2xl border border-[#DDE4DE] dark:border-gray-800 shadow-[0_8px_30px_rgba(16,33,29,0.05)] p-8">
          ...
          <form className="space-y-4" onSubmit={handleRegister} noValidate>
            <div className="space-y-1.5">
              <label htmlFor="name" className="text-sm font-medium text-[#10211D] dark:text-gray-300">Full Name</label>
            ...
            <div className="space-y-1.5">
              <label htmlFor="reg-email" className="text-sm font-medium text-[#10211D] dark:text-gray-300">Email</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label htmlFor="reg-password" className="text-sm font-medium text-[#10211D] dark:text-gray-300">Password</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label htmlFor="reg-confirm" className="text-sm font-medium text-[#10211D] dark:text-gray-300">Confirm Password</label>
              <div className="relative">
                <IconLock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
                <input
                  id="reg-confirm"
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed pt-1">
              ...
              <span className="text-[#00A94F] hover:underline cursor-pointer">Terms of Service</span>
              {" "}and{" "}
              <span className="text-[#00A94F] hover:underline cursor-pointer">Privacy Policy</span>.
            </p>

            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#10211D] py-3 text-sm font-semibold text-white hover:bg-[#1a332c] transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-4"
            >
              {loading ? (
                <IconLoader2 className="h-4 w-4 animate-spin" />
              ) : (
          ...
          <p className="text-center text-sm text-[#68736E] dark:text-gray-400">
            ...
            <Link to="/login" className="font-medium text-[#00A94F] hover:underline">
              Sign in here
            </Link>
          </p>
        </div>
